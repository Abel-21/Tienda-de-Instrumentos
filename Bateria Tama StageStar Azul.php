...
if(isset($_SESSION["uid"])){
	header("location:Bateria Tama StageStar Azul_S.php");
}
?>
<!DOCTYPE html>
<html lang="es">
...
<body style="padding: 55px 0px">
  ...
  <div class="container">
    <div class="row align-items-center my-5 ">
      ...
      <center>
        <h2 class="text-uppercase">Bateria Tama StageStar Azul</h2>
        <p class="item-intro text-muted">Batería Tama Stagestar Azul Sg52kh6c-db</p>
        <table style=”width: 100%”>
          ...
          <td>
            <center>
              <img class="img-fluid" src="img/Baterias/bateria2.jpg" width="300" height="500">
              <b>
          ...
          <td>
            ...
            <div style="color: #6c757d">
              ...
              TRAE PARA TI:
              Batería Tama Stagestar Azul Sg52kh6c-db
