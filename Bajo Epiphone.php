...
if(isset($_SESSION["uid"])){
	header("location:Bajo Epiphone_S.php");
}
?>
<!DOCTYPE html>
<html lang="es">
  ...
  <div class="container">
          <div class="row align-items-center my-5 ">
                ...
                <center>
                <h2 class="text-uppercase">Bajo Epiphone</h2>
                <p class="item-intro text-muted">Bajo Epiphone EB-3 Cherry</p>
            ...
            <br>
                ...
                <div style="color: #6c757d">Con un ligero cuerpo de caoba, estilo cutaway, un sólido brazo de gran escala y exclusivas pastilla de alto nivel, el clásico bajo EB-3 tiene el mejor sustain y un sonido fascinante que hará vibrar el escenario.
<li>Modelo: EBG3CHCH1</li> 
<li>Marca: Epiphone</li> 
</div>>
  </td>
  </table>
  </center>
