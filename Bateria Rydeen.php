...
if (isset($_SESSION["uid"])) {
    header("location:Bateria Rydeen_S.php");
}
?>
<!DOCTYPE html>
<html lang="es">
...
<body style="padding: 55px 0px">
  ...
  <div class="container">
    <div class="row align-items-center my-5 ">
      ...
      <center>
        <h2 class="text-uppercase">Bateria electronica Rydeen</h2>
        <p class="item-intro text-muted">Bateria Rydeen Yamaha Plata</p>
        <table style=”width: 100%”>
          ...
          <td>
            <center>
              <img class="img-fluid" src="img/Baterias/bateria3.jpg" width="300" height="500">
              <b>
          ...
          <td>
            ...
            <div style="color: #6c757d">
              Nueva batería acústica de iniciación RYDEEN

              2 size Variations(5-piece shell pack)
              6 Color Variations
