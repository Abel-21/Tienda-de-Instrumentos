...
if (!isset($_SESSION["uid"])) {
    header("location:Piano Yamaha NP32.php");
}
?>
<!DOCTYPE html>
<html lang="es">
...
<body style="padding: 55px 0px">
    ...
    <div class="container">
        <div class="row align-items-center my-5 ">
            ...
            <center>
                <h2 class="text-uppercase">Piano Yamaha NP32</h2>
                ...
                <table style=”width: 100%”>
                    ...
                    <td>
                        <center>
                            <img class="img-fluid" src="img/Teclados/teclado4.jpg" width="300" height="500">
                            <b>
                            ...
                            <form action="guardarbd.php">
                                ...
                                <div>
                                    <input type="hidden" name="g1" value="12">
                                </div>
                    ...
                    <td>
                        ...
                        <p style="color: #6c757d">
                            Voz de piano de cola estéreo muestreado legendaria de Yamaha le da tono realista, mientras que las dimensiones compactas y peso ligero del NP32 hacen de este instrumento un piano sea muy ligero.
