...
if(isset($_SESSION["uid"])){
	header("location:Piano Profesional Roland_S.php");
}
?>
<!DOCTYPE html>
<html lang="es">
  ...
  <div class="container">
          <div class="row align-items-center my-5 ">
                ...
                <center>
                <h2 class="text-uppercase">Piano Profesional Roland</h2>
                <p class="item-intro text-muted">Piano Profesional Roland RD-2000</p>
                ...
                <td>
                  <center>
                <img class="img-fluid" src="img/Teclados/teclado3.jpg" width="400" height="100">
                <br>
                <b>
