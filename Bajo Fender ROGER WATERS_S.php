...
if (!isset($_SESSION["uid"])) {
    header("location:Bajo Fender ROGER WATERS.php");
}
?>
<!DOCTYPE html>
<html lang="es">
                ...
                <table style=”width: 100%”>
                    ...
                    <td>
                        <center>
                            ...
                            <form action="guardarbd.php">
                                ...
                                <div>
                                    <input type="hidden" name="g1" value="6">
                                </div>
                    ...
                    <td>
                        ...
                        <div style="color: #6c757d">El Roger Waters Precision Bass ofrece el sonido y estilo de referencia del aclamado bajista/vocalista/compositor, cuyos elegantes ritmos conforman el sello de identidad clásico de Pink Floyd, además de una carrera en solitario que sigue actualmente con más fuerza que nunca. El instrumento está realizado con el mismo gusto que el trabajo bajístico simple pero sofisticado del propio Waters, y ofrece un distintivo acabado en color negro y un sonido de gran potencia y matices.
                            ...
                            <li>Puente en color negro de estilo vintage con cuatro selletas de ranura única</li>
                        </div>
