...
if(isset($_SESSION["uid"])){
	header("location:Piano Kurzweil_S.php");
}
?>
<!DOCTYPE html>
<html lang="es">
  ...
  <div class="container">
          <div class="row align-items-center my-5 ">
                ...
                <center>
                <h2 class="text-uppercase">Piano Kurzweil</h2>
                <p class="item-intro text-muted">Piano Kurzweil PC3A8</p>
                ...
                <td>
                  <center>
                <img class="img-fluid" src="img/Teclados/teclado2.jpg" width="400" height="100">
                <br>
            ...
            <br>
                ...
                <div style="color: #6c757d">
                  <li>Marca: Kurzweil</li>
                  <li>Modelo: SP 4-7</li>
                  <li>Acabado: Negro</li>
                  <li>Cantidad de teclas: 76</li>
                </div>
  </table>
  </center>
 </div>
